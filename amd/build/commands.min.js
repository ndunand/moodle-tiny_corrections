define("tiny_corrections/commands",["exports","core/str","./common","./options"],(function(_exports,_str,_common,_options){function addCorrection(editor){let correction_types_array=function(editor){let correction_types=(0,_options.getCorrTypes)(editor);return correction_types=correction_types.replace(/\n$/,""),correction_types.split("\n").map((line=>{let[value,text]=line.split("=");return{text:text,value:value}}))}(editor);editor.windowManager.open({title:"Add a correction",body:{type:"panel",items:[{type:"selectbox",name:"correction_type",label:"Correction type",items:correction_types_array},{type:"textarea",name:"correction_comment",label:"Comment"}]},buttons:[{type:"submit",text:"OK"}],initialData:{correction_type:"none",correction_comment:""},onSubmit:api=>{!
/**
