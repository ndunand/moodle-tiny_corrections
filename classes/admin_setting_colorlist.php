...
/**
 * Class that allow configuring a corrections color list.
 *
...
class admin_setting_colorlist extends admin_setting {
    ...
    public function output_html($data, $query='') {
        ...
        $context = (object) [
            'header' => [
                'name' => get_string('placeholdercolorname', 'tiny_corrections'),
                'value' => get_string('placeholdercolorvalue', 'tiny_corrections'),
            ],
            'id' => $this->get_id(),
        ...
        $html = $OUTPUT->render_from_template('tiny_corrections/settings_config_color', $context);
